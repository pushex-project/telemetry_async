...
Supervisor.start_link([{TelemetryAsync.ShardSupervisor, pool_size: 4, prefix: :steve}], [strategy: :one_for_one])
Supervisor.start_link([{TelemetryAsync.Handler, pool_size: 4, prefix: :steve, metrics: metrics}], [strategy: :one_for_one])
...
:telemetry.attach(:test, [:async, :test], fn a, b, c, d ->
  IO.inspect {a,b,c,d}
end, nil)
